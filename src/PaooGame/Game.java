...
public class Game implements Runnable
{
   ...
   // private GameCamera gameCamera;
    ...
    public void run()
    {
        ...
        final double timeFrame      = 1000000000 / framesPerSecond; /*!< Durata unui frame in nanosecunde.=> 60 fps/sec */
